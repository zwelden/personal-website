    ...
    const workHistory = [
        {
            ...
            description: 'Trucking and construction industry ATS, recruting, compliance, and safety platform. Lead developer for the FMCSA/CSA monitoring, construction documents and forms exchange, and "Insights" retention survey products.',
